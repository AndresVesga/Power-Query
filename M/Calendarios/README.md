...
Esta carpeta contiene un conjunto de **funciones y tablas en lenguaje M (Power Query)**, junto con un archivo de ejemplo en Power BI (`.pbix`), para la construcción de **modelos de datos robustos, escalables y reutilizables**.
